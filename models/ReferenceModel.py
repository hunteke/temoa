...
model.xc = Var( model.tech_new, model.invest_period,               within=NonNegativeReals, bounds=(0, 1e12) )
model.xu = Var( model.tech_all, model.invest_period, model.period, within=NonNegativeReals, bounds=(0, 1e12) )

model.PeriodCost = Var( model.operating_period, within=NonNegativeReals )

# Objective function(s)
def TotalCost ( model ):
    return summation( model.PeriodCost )
