# -*- coding: utf-8 -*-
#
# Temoa Project documentation build configuration file, created by
# sphinx-quickstart on Sat May 12 14:17:54 2012.
#
...
release = time.strftime( "%F", time.gmtime() ) # '1.0'
...
# of the sidebar.
html_logo = 'images/TemoaLogo.svg'
...
htmlhelp_basename = 'TemoaProjectdoc'
...
# the title page.
latex_logo = 'images/TemoaLogo.pdf'
...
man_pages = [
    ('index', 'temoaproject', u'Temoa Project Documentation',
     [u'Kevin Hunter, Joseph DeCarolis, Sarat Sreepathi'], 1)
]
...
texinfo_documents = [
  ('index', 'TemoaProject', u'Temoa Project Documentation',
   u'Kevin Hunter, Joseph DeCarolis, Sarat Sreepathi', 'TemoaProject', 'One line description of project.',
   'Miscellaneous'),
]
